...
import cn.dorado.plugins.components.TargetSelectionDialog;
import cn.dorado.plugins.generators.CodeType;
import cn.dorado.plugins.generators.Generator;
...
//        Messages.showMessageDialog("Hello World!", "Information", Messages.getInformationIcon());
        ...
        //定义要生成的类的名称
        String preferredClassName = selectedClass.getName() + "Data";
        //获得类的包名
        ...
        if(targetSelectionDialog.isOK()){
            String packageName=targetSelectionDialog.getSelectedTargetClassPanel().getPackageName();
           generatorProperties.setPackageName(packageName);
            generatorProperties.setEntityPackageName(preferredPackageName);
            Generator generator =new Generator(CodeType.DTO,selectedClass,packageName,generatorProperties);
            generator.generate();
